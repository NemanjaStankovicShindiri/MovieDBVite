...
${indent}  "${refs[i]}":`;
  ...
  getNonDefaults() {
    ...
    if (this.colorUl === this.colorUr && this.colorBl === this.colorBr && this.colorUl === this.colorBl) {
      if (this.colorUl !== 4294967295) settings.color = this.colorUl.toString(16);
    } else {
      if (this.colorUl !== 4294967295) settings.colorUl = this.colorUl.toString(16);
      if (this.colorUr !== 4294967295) settings.colorUr = this.colorUr.toString(16);
      if (this.colorBl !== 4294967295) settings.colorBl = this.colorBl.toString(16);
      if (this.colorBr !== 4294967295) settings.colorBr = this.colorBr.toString(16);
    }
  ...
  toJSON() {
    ...
    if (this.hasChildren()) {
      ...
      tree[ref] = { ..._Element.getProperties(this) };
    }
    return tree;
  }
...
var StateMachine = class _StateMachine {
  ...
  static _getSharedState(state1, state2) {
    ...
    const state2Array = _StateMachine._getAncestorStates(state2);
...
var TextureThrottler = class _TextureThrottler {
  ...
  processSome() {
    if (this._sources.length) {
      ...
      do {
        this._processItem();
      } while (this._sources.length && Date.now() - start < _TextureThrottler.MAX_UPLOAD_TIME_PER_FRAME);
    }
  }
  _processItem() {
...
//# sourceMappingURL=chunk-6H3FISAG.js.map
